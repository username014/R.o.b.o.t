    ...
    if hod == 0:
        ...
        if b == UP and c == RIGHT and d == DOWN:
            ...
            if x == 1:
                print("9*")
                new_step = s[randint(0, 3)]
                while new_step == UP or new_step == reverse[old_step] or new_step == LEFT:
                    new_step = s[randint(0, 3)]
            elif y == 1:
                print("10*")
                new_step = s[randint(0, 3)]
                ...
                print("11*")
                new_step = s[randint(0, 3)]
                while new_step == DOWN or new_step == reverse[old_step] or new_step == LEFT:
                    new_step = s[randint(0, 3)]
            elif y == wfield:
                print("12*")
                new_step = s[randint(0, 3)]
                while new_step == RIGHT or new_step == reverse[old_step] or new_step == LEFT:
                    new_step = s[randint(0, 3)]
            print("1*")
            ...
            if x == 1:
                print("9*")
                new_step = s[randint(0, 3)]
                while new_step == UP or new_step == reverse[old_step] or new_step == RIGHT:
                    new_step = s[randint(0, 3)]
            elif y == 1:
                print("10*")
                new_step = s[randint(0, 3)]
                while new_step == LEFT or new_step == reverse[old_step] or new_step == RIGHT:
                    new_step = s[randint(0, 3)]
            elif x == wfield:
                print("11*")
                new_step = s[randint(0, 3)]
                while new_step == DOWN or new_step == reverse[old_step] or new_step == RIGHT:
                    new_step = s[randint(0, 3)]
            elif y == wfield:
                print("12*")
                new_step = s[randint(0, 3)]
            ...
            if x == 1:
                ...
                print("10*")
                new_step = s[randint(0, 3)]
                while new_step == LEFT or new_step == reverse[old_step] or new_step == UP:
                    new_step = s[randint(0, 3)]
            elif x == wfield:
                print("11*")
                new_step = s[randint(0, 3)]
                while new_step == DOWN or new_step == reverse[old_step] or new_step == UP:
                    new_step = s[randint(0, 3)]
            elif y == wfield:
                print("12*")
                new_step = s[randint(0, 3)]
                while new_step == RIGHT or new_step == reverse[old_step] or new_step == UP:
                    new_step = s[randint(0, 3)]
            ...
            if x == 1:
                print("9*")
                new_step = s[randint(0, 3)]
                while new_step == UP or new_step == reverse[old_step] or new_step == DOWN:
                    new_step = s[randint(0, 3)]
            elif y == 1:
                print("10*")
                new_step = s[randint(0, 3)]
                while new_step == LEFT or new_step == reverse[old_step] or new_step == DOWN:
                    new_step = s[randint(0, 3)]
            elif x == wfield:
                print("11*")
                new_step = s[randint(0, 3)]
                ...
                print("12*")
                new_step = s[randint(0, 3)]
                while new_step == RIGHT or new_step == reverse[old_step] or new_step == DOWN:
                    new_step = s[randint(0, 3)]
